...
Um die Anfragebearbeitung nachzuvollziehen, seien im Folgenden zwei Relationen \textit{Angestellte} und \textit{Projekt} wie in den Abbildungen \ref{abb:angestellte} und \ref{abb:projekt} gegeben.
\begin{figure}
    \centering
