...
\begin{defi}[Gefaltete Übertragungsfunktion]
    ...
    \end{equation*}
    wird gefaltete Übertragungsfunktion bezeichnet. Mit $\ast$ ist die zweidimensionale Faltung wie in Definition \ref{def:matrix_faltung} gemeint.und mit $\cdot$ werden beliebige Raumachsen bezeichnet.
\end{defi}
