...
\begin{algorithm}[H]
    ...
    \For{$(x,c) \in \mathcal{T}$}
        ...
        \For{Schichten $l=L-1, \ldots 1$}
             \For{Karten $j=1, \ldots, s_l$}
                \For{\textbf{all} Pixel $(x,y)$}
                    ...
                    \If{Schicht $l+1$ ist Faltungschicht}
        ...
        \For{$l=1, \ldots, L$}
            ...
            \If{Schicht $l$ ist Faltungschicht}
...
\end{align*} den lokalen Fehler $\delta^{C^2}_{q,\psi}$ der Faltungschicht $C^2$. Damit ergibt sich wegen der Ableitung der logistischen Funktion
\begin{equation*}
