...
Das Faltungstheorem stellt ein Zusammenhang zwischen der zyklischen Faltung aus Definition \ref{def:cycconv} und der diskreten Fourier-Transformation wie in Definition \ref{def:dft} her. Eine Version davon wird im weiteren Verlauf dieser Arbeit genutzt, um die Matrixfaltung, vgl. Definition \ref{def:matrix_faltung}, mithilfe von Fourier-Transformationen zu berechnen.
